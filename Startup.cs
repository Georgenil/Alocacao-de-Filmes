...
namespace MinhaAppVS
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddEntityFrameworkNpgsql().AddDbContext<MeuDbContext>(options =>
                options.UseNpgsql(Configuration.GetConnectionString("MeuDbContext")));

            services.AddRazorPages()
            .AddRazorRuntimeCompilation();

            //services.AddDbContext<MinhaAppVSContext>(options =>
            //options.UseSqlServer(Configuration.GetConnectionString("MinhaAppVSContext")));
